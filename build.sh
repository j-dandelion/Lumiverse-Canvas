...
sed -i "s|export const CANVAS_VERSION = ''|export const CANVAS_VERSION = '$VERSION'|" src/persist/backend-ctx.ts
...
sed -i "s|export const CANVAS_VERSION = '$VERSION'|export const CANVAS_VERSION = ''|" src/persist/backend-ctx.ts
